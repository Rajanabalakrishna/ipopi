...
import 'package:ipopi/feautres/notes/presentation/bloc/notes_bloc.dart';
...
NotesBloc createNotesBloc() {
  final dataSource = NotesRemoteDataSourceImpl(
    FirebaseFirestore.instance, const Uuid(),
  );
  final repository = NotesRepositoryImpl(dataSource);

  return NotesBloc(
    watchNotesUseCase: WatchNotesUseCase(repository), // ✅ correct
